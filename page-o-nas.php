        ...
        <div class="col-6">
          <div class="about__content">
            ...
            <div class="about__texts">
              <p>Мы - образовательный центр для детей и подростков, где обучение строится вокруг практики, интереса и понятного результата. Наши курсы помогают развивать мышление, логику, внимание и уверенность в себе через современные направления - от программирования и робототехники до творчества и математики.</p>

              <p>Мы работаем с детьми разного возраста и уровня подготовки, помогая сделать первые шаги или углубить уже существующие интересы. Ребёнок не просто посещает занятия - он пробует, создаёт и видит свой прогресс.</p>
            </div>
      ...
      <div class="row about-for-whom__bottom">
        <div class="col-8">
          <article class="about-for-whom__wide">
            <h3 class="about-for-whom__wide-title">Для подростков, которые <span>задумываются о будущем</span></h3>
