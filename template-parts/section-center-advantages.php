<section class="section center-advantages">
  <div class="container">
    <div class="row">
      <div class="col-8">
        <div class="row">
          <div class="col-12">
            <h2 class="center-advantages__title">Почему родители выбирают наш центр</h2>
          </div>
        </div>
      ...
      <div class="col-4">
        <div class="center-advantages__aside">
          ...
          <button class="center-advantages__aside-cta" type="button">Записаться на бесплатный урок</button>
        </div>
      </div>
    </div>
  </div>
