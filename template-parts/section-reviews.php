        ...
        <div class="reviews__track" data-reviews-track>
          ...
          $reviews = [
            ...
            [
              'img' => '/assets/img/face-bg-01.jpg',
              'name' => 'Мария',
              'text' => 'Отличная атмосфера и небольшие группы. Ребёнок стал увереннее и больше интересуется IT. Понравилось, что всё объясняют спокойно и по шагам. Видим прогресс уже через пару недель.',
            ],
            [
              'img' => '/assets/img/face-bg-02.jpg',
              'name' => 'Дмитрий',
